...
public class CustomizedParameterizedOutputVisitorUtils {
    ...
    public static String parameterize(String sql
        ...
        if (visitor.getReplaceCount() == 0
            ...
            boolean notUseOriginalSql = true;
    ...
    public static ParameterizedVisitor createParameterizedOutputVisitor(Appendable out, DbType dbType) {
        System.out.println("in CustomizedParameterizedOutputVisitorUtils");
        if (dbType == null) {
            dbType = DbType.other;
        }
        ...
        switch (dbType) {
            ...
            default:
                return new CustomizedSQLASTOutputVisitor(out, true);
        }
    }
