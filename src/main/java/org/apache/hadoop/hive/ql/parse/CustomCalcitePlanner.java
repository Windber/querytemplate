...
public class CustomCalcitePlanner extends SemanticAnalyzer {
    ...
    public CustomCalcitePlanner(QueryState queryState) throws SemanticException {
        super(queryState);
    ...
    boolean canCBOHandleAst(ASTNode ast, QB qb, PreCboCtx cboCtx) {
        ...
        // be handled.
        String msg = CustomCalcitePlanner.canHandleQbForCbo(queryProperties, conf, true, needToLogMessage, qb);
        if (msg == null) {
            return true;
        }
        if (needToLogMessage) {
    ...
    Table materializeCTE(String cteName, CTEClause cte) throws HiveException {
        ...
        CustomCalcitePlanner analyzer = new CustomCalcitePlanner(queryState);
        ...
        // For CustomCalcitePlanner, store qualified name too
    ...
    RelNode logicalPlan() throws SemanticException {
        ...
        CustomCalcitePlannerAction CustomCalcitePlannerAction = null;
        if (this.columnAccessInfo == null) {
            this.columnAccessInfo = new ColumnAccessInfo();
        }
        CustomCalcitePlannerAction = new CustomCalcitePlannerAction(
                prunedPartitions,
                ctx.getOpContext().getColStatsCache(),
                this.columnAccessInfo);

        try {
            optimizedOptiqPlan = Frameworks.withPlanner(CustomCalcitePlannerAction, Frameworks
     ...
     */
    private class CustomCalcitePlannerAction implements Frameworks.PlannerAction<RelNode> {
