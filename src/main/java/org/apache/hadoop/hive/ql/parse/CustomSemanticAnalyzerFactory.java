 ...
 *
 */
public final class CustomSemanticAnalyzerFactory {
    static final private Logger LOG = LoggerFactory.getLogger(CustomSemanticAnalyzerFactory.class);
            ...
            switch (tree.getType()) {
                ...
                default: {
                    SemanticAnalyzer semAnalyzer = HiveConf
                            ...
                            new CustomCalcitePlanner(queryState) : new SemanticAnalyzer(queryState);
                    return semAnalyzer;
                }
            }
        }
    ...
    private CustomSemanticAnalyzerFactory() {
