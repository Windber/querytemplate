 ...
 */
public class CustomHiveSqlDialect extends SqlDialect {
    public static final SqlDialect DEFAULT =
            new CustomHiveSqlDialect(EMPTY_CONTEXT
                    .withDatabaseProduct(DatabaseProduct.HIVE)
                    .withNullCollation(NullCollation.LOW));

    private final boolean emulateNullDirection;

    /** Creates a CustomHiveSqlDialect. */
    public CustomHiveSqlDialect(Context context) {
        super(context);
