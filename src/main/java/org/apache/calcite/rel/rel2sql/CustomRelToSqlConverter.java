 ...
 */
public class CustomRelToSqlConverter extends CustomSqlImplementor
    ...
    /** Creates a CustomRelToSqlConverter. */
    public CustomRelToSqlConverter(SqlDialect dialect) {
        super(dialect);
    ...
    public Result visit(TableScan e) {
        String [] ss = e.getTable().getQualifiedName().get(0).split("\\.");
        List<String> sl = Lists.newArrayList(ss);
        final SqlIdentifier identifier =
                new SqlIdentifier(sl, SqlParserPos.ZERO);
...
// End CustomRelToSqlConverter.java
